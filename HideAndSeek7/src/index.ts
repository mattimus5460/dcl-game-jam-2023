...
export function main() {
  ...
  MeshRenderer.setPlane(wall1, [0, 0.5, 0, 1, 0.5, 1, 0.5, 0.5, 0, 0.5, 0, 1, 0.5, 1, 0.5, 0.5])
  ...
  MeshRenderer.setPlane(wall2, [0.5, 0.5, 0.5, 1, 1, 1, 1, 0.5, 0.5, 0.5, 0.5, 1, 1, 1, 1, 0.5])
  ...
  MeshRenderer.setPlane(wall3, [0, 0, 0, 1, 0.5, 1, 0.5, 0, 0, 0, 0, 1, 0.5, 1, 0.5, 0])
  ...
  MeshRenderer.setPlane(wall4, [0.5, 0, 0.5, 1, 1, 1, 1, 0, 5, 0, 0.5, 1, 1, 1, 1, 0])
  ...
  let ILoveCats: Dialog[] = [
    {
      text: `Oh... um, hello there. I'm Sarah. I... I'm feeling really sad because I'm stuck in this scary nightmare. Can you help me, please? I'll explain how to get out, okay?`
    },
    {
      text: `To leave this place you must follow these steps: 
            \n1. Defeat the ghost and collect energy.`
    },
    {
      text: `\n2. Power up the dream beacons using the energy. 
             \n3. Protect the bed beacon from power loss.`
    },
    {
      text: `\nYour goal is to power up all the dream beacons to release the nightmare.`
    },
    {
