...
const beaconPositions = [Vector3.create(11, 0, 9), Vector3.create(8, 0, 24), Vector3.create(10, 0, 40)]
...
export const initBeacons = () => {
  ...
  const homeBeacon = new Beacon(Vector3.create(24, 0.5, 27), beaconPositions.length, true)
